/*
   Developed by Nilesh Patil on March 117
*/ 
...
#define AIO_USERNAME    "xyz"            // Replace it with your username
#define AIO_KEY         "xyz"   // Replace with your Project Auth Key
